package ca.ucalgary.cpsc.nrg.sdnsimulator.core;
...
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.agent.DefaultReceiver;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.agent.DefaultSender;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.agent.ESDTCPReceiverv1;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.agent.ESDTCPSenderv1;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.agent.Receiverv2;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.agent.Senderv2;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.controller.Controllerv1;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.controller.Controllerv2;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.controller.DefaultController;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.host.DefaultHost;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.link.DefaultLink;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.sdnswitch.DefaultSDNSwitch;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.entity.network.sdnswitch.SDNSwitchv1;
...
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.utility.Statistics;
import ca.ucalgary.cpsc.nrg.sdnsimulator.core.utility.datastructure.OneToOneMap;
...
public class Simulator {
	...
	public void createLink(String label, String srcNodeLabel, String dstNodeLabel, short linkType,
		...
		case Keywords.Entities.Nodes.Types.SDNSwitch:
			net.switches.get(srcNodeID).connectToNode(link.getID(), dstNodeID,
		...
		case Keywords.Entities.Nodes.Types.Controller:
			net.controllers.get(srcNodeID).connectToNode(link.getID(), dstNodeID,
					getNodeType(dstNodeID));
			break;
		default:
			break;
		...
		case Keywords.Entities.Nodes.Types.SDNSwitch:
			net.switches.get(dstNodeID).connectToNode(reverseLink.getID(), srcNodeID,
					getNodeType(srcNodeID));
			break;
		case Keywords.Entities.Nodes.Types.Host:
			net.hosts.get(dstNodeID).connectToNode(reverseLink.getID(), srcNodeID,
					getNodeType(srcNodeID));
			break;
		case Keywords.Entities.Nodes.Types.Controller:
			net.controllers.get(dstNodeID).connectToNode(reverseLink.getID(), srcNodeID,
					getNodeType(srcNodeID));
			break;
		default:
			break;
