...
public class IncastBufferingWithAlpha extends Scenario {

	public IncastBufferingWithAlpha() {
		super("IncastBufferingWithAlpha", "Number of Flows");
	}
	...
	public void executeTest() {
		...
		for (float alpha = 0.75f; alpha > 0f; alpha = Mathematics.subtractFloat(alpha, 0.25f)) {
			secondFactorValues.add(alpha);
		}

		for (float secondFactor : secondFactorValues) {
			Debugger.debugToConsole("------------ Alpha: " + secondFactor);
